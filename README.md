...
|-------------------------------------- |--------------|----------------------|--------------------------|---------|         
| Up-to-date requirements.txt           | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ML/detect-features`                  | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ML/artifact`                         | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ML/feature`                          | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ML/metric`                           | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ML/metric/extensions`                | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ML/model`                            | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ML/model/extensions`                 | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ML/pipeline/evaluation`              | FN           | Ceviker Sinan-Deniz  |    X    | | 
| `ST/page/datasets`                    | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ST/datasets/management/create`       | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ST/datasets/management/save`         | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ST/page/modelling`                   | NF           | Ceviker Sinan-Deniz  |    X    | |
| `ST/modelling/datasets/list`          | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ST/modelling/datasets/features`      | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ST/modelling/models`                 | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ST/modelling/pipeline/split`         | FN           | Ceviker Sinan-Deniz  |    X    | |
| `ST/modelling/pipeline/metrics`       | FN           | Ceviker Sinan-Deniz  |    X    | |
